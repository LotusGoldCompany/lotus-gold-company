...
import { Star, Coins, Unlock, ArrowRight, Menu, X, Microscope, ShieldCheck, CheckSquare, Phone, Award, FileText, Banknote, Zap, ChevronDown, MapPin, SearchCheck, CheckCircle2 } from 'lucide-react';
import ContactForm from '../src/components/ContactForm';
import ReviewModal from '../src/components/ReviewModal';
import WhatsAppButton from '../src/components/WhatsAppButton';
import FlashcardsSection from '../src/components/FlashcardsSection';

const advantageImages = [
  { src: '/lgc-1.avif', alt: 'Lotus Gold Company branch interior - gold buying office' },
  { src: '/lgc-2.avif', alt: 'Computer gold purity testing machine at Lotus Gold Company' },
  { src: '/lgc-3.avif', alt: 'Gold jewelry being weighed on accurate scales at Lotus Gold Company' },
  { src: '/lgc-5.avif', alt: 'Transparent gold valuation process at Lotus Gold Company' },
  { src: '/lgc-6.avif', alt: 'Instant cash payment for gold at Lotus Gold Company' },
];
const myLogo = '/lotus-logo.avif';
const heroModel = '/model-lady.avif';
...
function App() {
  ...
  const faqs = lang === 'en' ? [
    ...
    { question: "Do you buy old or broken gold jewelry?", answer: "Yes, we buy all types of gold — old jewelry, broken chains, bent bangles, single earrings, coins, and even gold bars. As long as it's genuine gold, we'll buy it at the live market rate." },
    { question: "What is the difference between 22K and 24K gold?", answer: "24K gold is 99.9% pure gold, usually in the form of coins or bars. 22K gold is 91.6% pure and is commonly used in Indian jewelry. We test and buy both, and the price is adjusted based on actual purity." },
    { question: "Do you charge any hidden fees or deductions?", answer: "Absolutely not. We have zero hidden charges. The rate we quote based on your gold's purity is the rate you get — no making charges, no processing fees, no deductions." },
    { question: "Can I sell gold that doesn't belong to me?", answer: "No. For legal and safety reasons, only the rightful owner of the gold can sell it. You must bring your own valid ID proof, and the gold must belong to you or someone who is present with their ID." },
    { question: "How is the gold price calculated?", answer: "We use the live international gold rate, convert it to INR using the current exchange rate, and then adjust for purity (e.g., 22K, 24K) and weight in grams. Everything is calculated right in front of you." },
    { question: "Do you provide a proper bill for the transaction?", answer: "Yes, we provide a proper GST bill for every transaction. This serves as legal proof of sale and can be used for your records or tax purposes." }
  ] : [
    ...
    { question: "ಹಳೆಯ ಅಥವಾ ಮುರಿದ ಚಿನ್ನದ ಆಭರಣಗಳನ್ನು ನೀವು ಖರೀದಿಸುತ್ತೀರಾ?", answer: "ಹೌದು, ನಾವು ಎಲ್ಲಾ ರೀತಿಯ ಚಿನ್ನವನ್ನು ಖರೀದಿಸುತ್ತೇವೆ — ಹಳೆಯ ಆಭರಣಗಳು, ಮುರಿದ ಸರಪಳಿಗಳು, ಬಾಗಿದ ಬಳೆಗಳು, ಏಕ ಕರ್ಣಭೂಷಣಗಳು, ನಾಣ್ಯಗಳು ಮತ್ತು ಚಿನ್ನದ ಬಾರ್‌ಗಳು. ಅದು ನಿಜವಾದ ಚಿನ್ನವಾಗಿದ್ದರೆ, ನಾವು ಲೈವ್ ಮಾರುಕಟ್ಟೆ ದರದಲ್ಲಿ ಖರೀದಿಸುತ್ತೇವೆ." },
    { question: "22K ಮತ್ತು 24K ಚಿನ್ನದ ನಡುವೆ ಯಾವ ವ್ಯತ್ಯಾಸವಿದೆ?", answer: "24K ಚಿನ್ನವು 99.9% ಶುದ್ಧ ಚಿನ್ನವಾಗಿದ್ದು, ಸಾಮಾನ್ಯವಾಗಿ ನಾಣ್ಯ ಅಥವಾ ಬಾರ್ ರೂಪದಲ್ಲಿರುತ್ತದೆ. 22K ಚಿನ್ನವು 91.6% ಶುದ್ಧವಾಗಿದ್ದು, ಭಾರತೀಯ ಆಭರಣಗಳಲ್ಲಿ ಸಾಮಾನ್ಯವಾಗಿ ಬಳಸಲಾಗುತ್ತದೆ. ನಾವು ಎರಡನ್ನೂ ಪರೀಕ್ಷಿಸಿ ಖರೀದಿಸುತ್ತೇವೆ, ಬೆಲೆ ನಿಜವಾದ ಶುದ್ಧತೆಯ ಆಧಾರದ ಮೇಲೆ ನಿರ್ಧರಿಸಲಾಗುತ್ತದೆ." },
    { question: "ಯಾವುದೇ ಗುಪ್ತ ಶುಲ್ಕಗಳು ಅಥವಾ ಕಡಿತಗಳಿವೆಯೇ?", answer: "ಇಲ್ಲ, ಸ್ವಲ್ಪವೂ ಇಲ್ಲ. ನಮಗೆ ಯಾವುದೇ ಗುಪ್ತ ಶುಲ್ಕಗಳಿಲ್ಲ. ನಿಮ್ಮ ಚಿನ್ನದ ಶುದ್ಧತೆಯ ಆಧಾರದ ಮೇಲೆ ನಾವು ನೀಡುವ ದರವೇ ನಿಮಗೆ ಸಿಗುವ ದರ — ಯಾವುದೇ ಮಾಡುವ ಶುಲ್ಕವಿಲ್ಲ, ಪ್ರಕ್ರಿಯಾ ಶುಲ್ಕವಿಲ್ಲ, ಯಾವುದೇ ಕಡಿತವಿಲ್ಲ." },
    { question: "ನನ್ನದಲ್ಲದ ಚಿನ್ನವನ್ನು ನಾನು ಮಾರಾಟ ಮಾಡಬಹುದೇ?", answer: "ಇಲ್ಲ. ಕಾನೂನು ಮತ್ತು ಸುರಕ್ಷತಾ ಕಾರಣಗಳಿಗಾಗಿ, ಚಿನ್ನದ ನಿಜವಾದ ಮಾಲೀಕರು ಮಾತ್ರ ಅದನ್ನು ಮಾರಾಟ ಮಾಡಬಹುದು. ನಿಮ್ಮ ಸ್ವಂತ ಮಾನ್ಯ ಗುರುತಿನ ಚೀಟಿ ತರಬೇಕು, ಮತ್ತು ಚಿನ್ನವು ನಿಮಗೆ ಸೇರಿದ್ದಾಗಿರಬೇಕು ಅಥವಾ ತಮ್ಮ ಗುರುತಿನ ಚೀಟಿಯೊಂದಿಗೆ ಮಾಲೀಕರು ಉಪಸ್ಥಿತರಿರಬೇಕು." },
    { question: "ಚಿನ್ನದ ಬೆಲೆ ಹೇಗೆ ಲೆಕ್ಕಹಾಕಲಾಗುತ್ತದೆ?", answer: "ನಾವು ಲೈವ್ ಅಂತರರಾಷ್ಟ್ರೀಯ ಚಿನ್ನದ ದರವನ್ನು ಬಳಸಿ, ಪ್ರಸ್ತುತ ವಿನಿಮಯ ದರದಲ್ಲಿ INR ಗೆ ಪರಿವರ್ತಿಸುತ್ತೇವೆ, ನಂತರ ಶುದ್ಧತೆ (ಉದಾ. 22K, 24K) ಮತ್ತು ಗ್ರಾಂ ತೂಕಕ್ಕೆ ಹೊಂದಿಸುತ್ತೇವೆ. ಎಲ್ಲವೂ ನಿಮ್ಮ ಕಣ್ಣೆದುರೇ ಲೆಕ್ಕಹಾಕಲಾಗುತ್ತದೆ." },
    { question: "ವಹಿವಾಟಿಗೆ ಸರಿಯಾದ ಬಿಲ್ ನೀಡುತ್ತೀರಾ?", answer: "ಹೌದು, ಪ್ರತಿಯೊಂದು ವಹಿವಾಟಿಗೂ ಸರಿಯಾದ GST ಬಿಲ್ ನೀಡುತ್ತೇವೆ. ಇದು ಮಾರಾಟದ ಕಾನೂನುಬದ್ಧ ಪುರಾವೆಯಾಗಿದ್ದು, ನಿಮ್ಮ ದಾಖಲೆ ಅಥವಾ ತೆರಿಗೆ ಉದ್ದೇಶಗಳಿಗೆ ಬಳಸಬಹುದು." }
  ];
  ...
  useEffect(() => {
    ...
    const fetchLiveRate = async () => {
      try {
        ...
        const forexRes = await fetch("https://open.er-api.com/v6/latest/USD", { signal: controller.signal });
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#FDF8EE] overflow-x-hidden">
          ...
          <div className="flex-1 lg:flex justify-end relative w-full lg:w-auto mt-12 lg:mt-0">
            <div className="relative w-full max-w-md mx-auto lg:mx-0 animate-float-slow">
              ...
              <div className="relative w-full overflow-visible group flex justify-center">
                <img
                  src={heroModel}
                  alt="Woman wearing traditional gold jewelry - Lotus Gold Company"
                  width={480}
                  height={640}
                  fetchPriority="high"
      ...
      {/* THE MARQUEE BRIDGE */}
      <div aria-label="Key features of Lotus Gold Company" className="bg-[#1A0510] py-4 overflow-hidden flex relative z-20 w-full shadow-[0_10px_30px_rgba(0,0,0,0.5)] border-y border-lotus-gold/20">
      ...
      {/* SERVICES SECTION */}
      <section id="services" aria-label="Gold services offered by Lotus Gold Company" className="py-24 bg-[#FDF8EE] px-6 relative">
      ...
      {/* ABOUT US SECTION */}
      <section id="about" aria-label="About Lotus Gold Company - Trusted since 2006 in Mysuru" className="py-24 bg-[#FDF8EE] px-6 border-b border-[#EDE5D0] overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative">
          ...
          <div className="flex-1 space-y-8 relative z-10">
            ...
            {lang === 'en' ? (
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-lotus-dark leading-tight tracking-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#926B15] via-[#B8860B] to-[#804000] drop-shadow-sm">{t.aboutCity}</span>
              </h2>
            ) : (
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-lotus-dark leading-tight tracking-tight">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#926B15] via-[#B8860B] to-[#804000] drop-shadow-sm">{t.aboutCity}</span> <br className="hidden md:block" />
                {t.aboutTitle}
              </h2>
            )}
            ...
            <div className="pt-6 flex items-center gap-6">
              <img src={myLogo} alt="Lotus Gold Company logo - Computer gold testing" width={112} height={56} className="h-14 w-auto object-contain transform scale-125 origin-left" />
          ...
          <div className="flex-1 w-full relative z-10 mt-10 lg:mt-0">
            <div className="grid grid-cols-2 gap-6 md:gap-8">
              <div className="bg-white p-6 md:p-8 rounded-[2rem] border-l-4 border-lotus-gold border-t border-r border-b border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-lg transition-shadow group">
                <div className="text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-lotus-dark to-lotus-light mb-2 group-hover:scale-105 transition-transform origin-left">2006</div>
                <p className="text-gray-500 font-bold uppercase tracking-wide text-xs md:text-sm">{t.est}</p>
              </div>

              <div className="bg-white p-6 md:p-8 rounded-[2rem] border-l-4 border-lotus-gold border-t border-r border-b border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-lg transition-shadow translate-y-0 md:translate-y-8 group">
                <div className="text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-lotus-dark to-lotus-light mb-2 group-hover:scale-105 transition-transform origin-left">10k+</div>
                <p className="text-gray-500 font-bold uppercase tracking-wide text-xs md:text-sm">{t.happy}</p>
              </div>

              <div className="bg-white p-6 md:p-8 rounded-[2rem] border-l-4 border-lotus-gold border-t border-r border-b border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-lg transition-shadow group">
                <div className="text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-lotus-dark to-lotus-light mb-2 group-hover:scale-105 transition-transform origin-left">100%</div>
                <p className="text-gray-500 font-bold uppercase tracking-wide text-xs md:text-sm">{t.honest}</p>
              </div>

              <div className="bg-gradient-to-br from-lotus-gold to-yellow-500 p-6 md:p-8 rounded-[2rem] shadow-lg hover:shadow-xl transition-shadow translate-y-0 md:translate-y-8 group">
                <div className="text-3xl md:text-4xl lg:text-5xl font-black text-lotus-dark mb-2 group-hover:scale-105 transition-transform origin-left">0%</div>
                <p className="text-lotus-dark/80 font-bold uppercase tracking-wide text-xs md:text-sm">{t.hidden}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section aria-label="How to sell gold at Lotus Gold Company - 3 simple steps" className="py-24 bg-[#FDF8EE] px-6 border-b border-[#EDE5D0]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
      ...
      {/* CAROUSEL SECTION */}
      <section aria-label="Why choose Lotus Gold Company - advantages gallery" className="py-24 bg-[#1A0510] relative overflow-hidden flex flex-col items-center border-y border-lotus-gold/10">
      ...
      {/* FAQ SECTION */}
      <section id="faq" aria-label="Frequently asked questions about selling gold in Mysuru" className="py-24 bg-[#FDF8EE] px-6 border-b border-[#EDE5D0]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-stretch">
            ...
            {/* Image - Right (Full Length) */}
            <div className="flex w-full lg:w-[40%] relative items-end justify-center lg:justify-end self-stretch pointer-events-none mt-12 lg:mt-0">
              <img
                src="/faq-model.avif"
                alt="Woman wearing traditional gold jewellery - Lotus Gold Company"
                width={400}
                height={700}
                className="relative lg:absolute bottom-0 right-0 h-[500px] md:h-[600px] lg:h-full w-auto max-w-none object-contain object-bottom drop-shadow-[0_10px_30px_rgba(43,9,23,0.15)] origin-bottom opacity-100"
                loading="lazy"
                style={{
      ...
      {/* REVIEWS SECTION */}
      <section id="reviews" aria-label="Customer reviews of Lotus Gold Company Mysuru" className="py-20 bg-[#FDF8EE] px-6 text-gray-800">
        <div className="max-w-7xl mx-auto">
      ...
      <section aria-label="Location of Lotus Gold Company in Devaraja Mohalla, Mysuru" className="py-20 bg-[#FDF8EE] px-6 border-b border-[#EDE5D0]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex-1 w-full relative h-[400px] rounded-[2rem] overflow-hidden shadow-2xl border border-gray-100">
            <iframe
              ...
              title="Lotus Gold Company location - Hompu Complex, Devaraja Mohalla, Mysuru, Karnataka 570001"
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10 mb-12 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="h-16 mb-6 mt-2 flex items-center justify-center md:justify-start w-full">
              <img
                src={myLogo}
                alt="Lotus Gold Company - Most Trusted Gold Buyer Since 2006"
                width={160}
                height={64}
                loading="lazy"
